...
import Banner from "../../../assets/Imagenes/img_!Phone/banner_principal.webp";
import { CellphonesProvider } from "../../../context/context.client/CellphonesContext";
import { ListCellphones } from "../../../components/others";
        ...
        <section className="conosenos container py-5">
          ...
          <div className="row justify-content-center gap-3">
            <div className="col-lg-2 col-md-5 mb-4 bg-light rounded p-3">
              ...
              <p>
                ¿Estás pensando en adquirir un nuevo iPhone? Con las Tarjetas de
            ...
            <div className="col-lg-2 col-md-5 mb-4 bg-light rounded p-3">
              <h4>Los iPhone más vendidos en el Perú</h4>
              <p>
                Los iPhone más vendidos en Perú destacan por su calidad y
            ...
            <div className="col-lg-2 col-md-5 mb-4 bg-light rounded p-3">
              ...
              <p>
                ...
                necesitas para potenciar tu iPhone en iShop Perú.
              </p>
            </div>

            <div className="col-lg-2 col-md-5 mb-4 bg-light rounded p-3">
              <h4>¿Dónde comprar un iPhone en Perú?</h4>
              <p>
                iShop es tu destino confiable para adquirir un iPhone en Perú.
              ...
              <p>¡Encuentra tu iPhone perfecto en iShop Perú hoy mismo!</p>
            </div>
          </div>
        </section>
      </CellphonesProvider>
